...
y_axis_data = [item for item in list(xyaxes['FINAL FUNCT PROD::WaferData::npuZQ']) if not(math.isnan(item)) == True]
...
graph1 = sns.lineplot(x='5450-51 SLIT RECESS WET ETCH::RunData::ProcessEndDateTime', y='FINAL FUNCT PROD::WaferData::npuZQ',data=xyaxes,hue='porconv',marker='o',ax=ax,ci=None)
graph2 = sns.lineplot(x='5450-51 SLIT RECESS WET ETCH::RunData::ProcessEndDateTime', y='FINAL FUNCT PROD::WaferData::npuZQ',data=xyaxes,hue='porconv',marker='o',ax=ax2,ci=None)
...
plt.savefig('npuZQ.png',bbox_inches='tight')
