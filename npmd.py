...
y_axis_data = [item for item in list(xyaxes['FINAL FUNCT PROD::WaferData::npmD']) if not(math.isnan(item)) == True]
...
#Plotting of 2 subplots
graph1 = sns.lineplot(x='5450-51 SLIT RECESS WET ETCH::RunData::ProcessEndDateTime', y='FINAL FUNCT PROD::WaferData::npmD',data=xyaxes,hue='porconv',marker='o',ax=ax,ci=None)
graph2 = sns.lineplot(x='5450-51 SLIT RECESS WET ETCH::RunData::ProcessEndDateTime', y='FINAL FUNCT PROD::WaferData::npmD',data=xyaxes,hue='porconv',marker='o',ax=ax2,ci=None)
...
plt.savefig('npmD.png',bbox_inches='tight')
